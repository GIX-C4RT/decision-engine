...
if __name__ == "__main__":
  ...
  mykinova_pool = Kinova_pool(1, ['localhost:50053'])
  print("request CheckOut1 coming")
  fetch = myfetch_pool.get_fetch()
  kinova = mykinova_pool.get_kinova()

  myfetchconfig = FetchConfig(operation="CheckOut", kit_ID=1, kit_location=1, target_location=1, call_back=lambda :print("CheckOut finished"))
