...
class DeweyKinovaServicer(object):
    """The Kinova service definition.
    """
...
def add_DeweyKinovaServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'DeweyKinova', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class DeweyKinova(object):
    """The Kinova service definition.
    """
    ...
    def Kinova_CheckOut(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DeweyKinova/Kinova_CheckOut',
    ...
    def Kinova_CheckIn(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DeweyKinova/Kinova_CheckIn',
