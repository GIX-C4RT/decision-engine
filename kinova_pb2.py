...
_DEWEYKINOVA = _descriptor.ServiceDescriptor(
  name='DeweyKinova',
  full_name='DeweyKinova',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='DeweyKinova.Kinova_CheckOut',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Kinova_CheckIn',
    full_name='DeweyKinova.Kinova_CheckIn',
    index=1,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_DEWEYKINOVA)

DESCRIPTOR.services_by_name['DeweyKinova'] = _DEWEYKINOVA
